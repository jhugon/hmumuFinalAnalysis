...
if True:
    if args.n2JetVBFTight or args.n2JetGFTight or args.n2JetVBFLoose:
      histNames["dimuonMass"] = {"xlabel":"M(#mu#mu) [GeV/c^{2}]","xlimits":[110.0,170.],"nbins":20}#,"ylimits":[0.1,5e5]}
    elif not args.n2Jet:
      histNames["dimuonMass"] = {"xlabel":"M(#mu#mu) [GeV/c^{2}]","xlimits":[110.0,170.],"nbins":50}#,"ylimits":[0.1,5e5]}
