...
anotateText = "M(#mu#mu) #in [105,165] GeV/c^{2}"
...
CUTS="dimuonMass < 165. && dimuonMass > 105."
...
if True:
    if args.n2JetVBFTight or args.n2JetGFTight or args.n2JetVBFLoose:
      histNames["dimuonMass"] = {"xlabel":"M(#mu#mu) [GeV/c^{2}]","xlimits":[105.0,165.],"nbins":20}#,"ylimits":[0.1,5e5]}
    elif not args.n2Jet:
      histNames["dimuonMass"] = {"xlabel":"M(#mu#mu) [GeV/c^{2}]","xlimits":[105.0,165.],"nbins":50}#,"ylimits":[0.1,5e5]}
