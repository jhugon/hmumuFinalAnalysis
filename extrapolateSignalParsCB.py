...
def Usage():
   print 'Wrong syntax: \n'
   print '   ./plotRooFitSignal.py [process] [benergy (7TeV,8TeV)] [fit (DG,CB)] [cat (BB,BO,...,EE,VBF)]\n'
...
for id in range(0,len(varNames)):
   ...
   #fitFunc = root.TF1("fitFunc","[0]+[1]*x",110.,160.)
   ...
   outfile = open(outputfile+'_CB.txt','w')
