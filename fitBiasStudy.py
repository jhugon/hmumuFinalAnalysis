...
def runStudy(iJob,iJobGroup,catName,energyStr,truePdfName,pdfAltNameList,dataFileNames,sigMasses,toysPerJob):
      ...
      trashParamList, trashBakNormTup, trashDebug, trueOrder = truePdfFunc(truePdfName+catName+energyStr,realData,dimuonMass,100,170,wTrueImport,dimuonMassZ,realDataZ,order=truePdfOrder)
      ...
      trashParamList, trashBakNormTup, trashDebug, trueToyOrder = truePdfFunc(trueToyPdfName,realData,dimuonMass,100,170,wTrueToyImport,dimuonMassZ,realDataZ,order=truePdfOrder)
      ...
      for pdfAltName,pdfAltNameNoOrder,pdfAltOrder,pdfAltFunc in zip(pdfAltNameList,altPdfNameNoOrderList,altPdfOrderList,pdfAltFuncList):
        ...
        pdfAltFunc(pdfName,realData,dimuonMass,100,170,getattr(wAlt,"import"),dimuonMassZ,realDataZ,order=pdfAltOrder)
        altPdf = wAlt.pdf("bak")
