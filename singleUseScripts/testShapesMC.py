...
frDY = pdf.fitTo(dataDY,root.RooFit.Save(),PRINTLEVEL,root.RooFit.SumW2Error(False))
frDY.Print()
...
frTT = pdf.fitTo(dataTT,root.RooFit.Save(),PRINTLEVEL,root.RooFit.SumW2Error(False))
frTT.Print()
...
frBoth = pdf.fitTo(dataBoth,root.RooFit.Save(),PRINTLEVEL,root.RooFit.SumW2Error(False))
frBoth.Print()
